  ...
  return (
    <div className='py-12 px-8 bg-gray-900'>
        ...
        <div className='mt-20 text-center'>
            <Link 
                href={"/courses"}
                className='px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 shadow-md hover:shadow-teal-200 transition duration-200'
            >
                View All courses
            </Link>
        </div>        
